...
new printer(model,Date,Time,racunxy,k);
    } 
...
public printer(DefaultTableModel model,String Date,String Time,String racunxy,String[] k) {
this.model=model;
this.Date=Date;
this.Time=Time;
this.racunxy=racunxy;
System.out.printf("%s %s %s",Date,Time,racunxy);
